...
from eteaching.plone.openbadges.views.open_badge_view import IOpenBadgeView
...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_view_is_registered(self):
        ...
        self.assertTrue(IOpenBadgeView.providedBy(view))
    ...
    def test_view_not_matching_interface(self):
        ...
        try:
            ...
            view_found = IOpenBadgeView.providedBy(view)
