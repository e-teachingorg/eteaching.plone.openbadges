...
from eteaching.plone.openbadges.views.issuer_view import IIssuerView
...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_issuer_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='issuer-view'
        )
        self.assertTrue(IIssuerView.providedBy(view))

    def test_issuer_view_not_matching_interface(self):
        view_found = True
        try:
            view = getMultiAdapter(
            ...
            view_found = IIssuerView.providedBy(view)
